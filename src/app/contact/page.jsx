          ...
          <div className="row">
                ...
                <div className="container-fluid p-0">
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <h4 className="d-block text-muted h5 mt-4">
                        In New York:
                      </h4>
                      <h4 className="d-block text-muted h6">......</h4>
                      <h4 className="d-block text-muted h6">......</h4>
            ...
            <div className="col-md-6 mt-5 mt-md-0">
              <div className="contact_form_head">
                ...
                <p>
                  For consulation, suggestions, comments, complaints or
                  estimates you may call us directly or contact us via the form
                  below.
                </p>
              </div>
              {/* contact form */}
